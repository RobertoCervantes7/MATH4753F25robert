...
inputPanel(
  selectInput("plotg", "Choose plot type",
      list(`Choose plot type` = c("linear regression line", "points", "points with line segments")
      )
    )
)
...
renderPlot({
 ...
 gh = ggplot(spruce.df, aes(x = BHDiameter, y = Height)) + geom_point() 
 
 gr = g + geom_line()
  
 if(input$plotg == "linear regression line") print(g)
 
 if(input$plotg == "points")   print(gh)
 
 if(input$plotg == "points with line segments")   print(gr)
