...
dird <- "/Users/robertcervantes/Documents/Labs (4753)/Lab 3/"
...
# Generic equation
eq_generic <- bquote(Height == B[0] + B[1]*x)

# Equation with actual coefficients
B0 <- 9.1468390
B1 <- 0.4814743
eq_actual <- bquote(Height == .(round(B0,3)) + .(round(B1,3))*BHDiameter)
